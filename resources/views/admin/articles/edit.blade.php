...
<div class="editor-wrapper">
    ...
    <form id="articleForm" action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="text-fields">
            ...
            <div>Başlık</div>
            <div name="title" class="editor-field single-line" contenteditable="true">{!! $article->title !!}</div>
            
            <div>Makale</div>
            <div name="content" class="editor-field multi-line" contenteditable="true">{!! $article->content !!}</div>
            
            <div>Yazar</div>
            <div name="author" class="editor-field single-line" contenteditable="true">{!! $article->author_name !!}</div>

            <div>Kategori</div>
            <div name="category" class="editor-field single-line" contenteditable="true">{!! $article->category !!}</div>
        </div>

        <div class="button-container">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="is_published" 
                       name="is_published" value="1" {{ $article->is_published ? 'checked' : '' }}>
